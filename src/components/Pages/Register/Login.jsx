...
<label className="label">
        ...
        <input type="submit" value="Submit" className=" rounded-md p-3 border-2 w-52 md:w-72 lg:w-80 mx-auto border-[#016A70] hover:bg-[#35A29F] hover:text-[#FFFBF5] text-xl uppercase font-medium"/>
        </div>
      </form>
    </div>
